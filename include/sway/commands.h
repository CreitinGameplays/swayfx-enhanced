...
sway_cmd cmd_fullscreen_anim;
sway_cmd cmd_fullscreen_anim_duration_ms;
sway_cmd cmd_gaps;
...
sway_cmd cmd_layout;
sway_cmd cmd_liquid_glass;
sway_cmd cmd_liquid_glass_bezel_width;
sway_cmd cmd_liquid_glass_brightness_boost;
sway_cmd cmd_liquid_glass_chromatic_aberration;
...
sway_cmd cmd_liquid_glass_thickness;
...
sway_cmd cmd_scrollable_tiling_touchpad_scroll_factor;
