...
#include <scenefx/types/fx/liquid_glass_data.h>
...
struct sway_config {
	...
	bool liquid_glass_enabled;
	struct liquid_glass_data liquid_glass_data;
	...
	enum sway_container_layout default_workspace_layout;
